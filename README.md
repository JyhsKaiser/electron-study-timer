...
- **Widget Always-On-Top:** Ventana minimalista sin bordes que se mantiene por encima de otras aplicaciones para no perder el foco.
- **Rutinas Dinámicas:** Crea, edita y elimina listas de actividades personalizadas con almacenamiento local persistente (CRUD).
